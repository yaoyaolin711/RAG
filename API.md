...
> 版本：v2.1.0  
> 基础地址：`http://localhost:8002`  
> 在线文档：[/docs](http://localhost:8002/docs) · [/redoc](http://localhost:8002/redoc)
...
```bash
curl http://localhost:8002/api/v1/meta
```
...
或双击根目录 `start_api.bat`，然后访问 http://localhost:8002/docs 查看交互式文档。
